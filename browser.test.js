...
const ADMIN = ['swim.js', 'swimmer.js', 'convert.js', 'school-utils.js', 'roster.js', 'questionnaire.js', 'photos.js', 'standards.js', 'board.js', 'recruiting.js'];
...
if (adminScope) {
  ...
  check('and carries every programme', adminScope.Roster.counts().total, 442);
}
